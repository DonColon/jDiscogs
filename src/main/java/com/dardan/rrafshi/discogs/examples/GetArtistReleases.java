...
public final class GetArtistReleases
{
	private static final Logger LOGGER = LoggerFactory.getLogger(GetArtistReleases.class);
	...
	public static void main(final String[] args)
	{
		...
		try {
			...
			final Page<SimpleRelease> page = discogs.getArtistReleases(artistID, PageRequest.getDefault());
